...
public class AdminForm extends javax.swing.JFrame {
    ...
    public void resetAllVotingStatus() {
        try {
            String sql = "UPDATE tbl_voters SET hasVoted = 'No'";
            PreparedStatement pstmt = conn.prepareStatement(sql);
            
            pstmt.executeUpdate();
            
            PopupWindows.dialogMessage("Voting Reset", "All voters have been reset to 'not voted'.");
        } catch (SQLException e) {
            PopupWindows.errorMessage("Voting Reset Error", e.getMessage());
        }
    }
